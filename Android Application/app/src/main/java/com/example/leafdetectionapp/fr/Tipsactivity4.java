...
public class Tipsactivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.leafdetectionapp.PagerAdapter4 pagerAdapter=new com.example.leafdetectionapp.PagerAdapter4(getSupportFragmentManager(),tabLayout.getTabCount());
